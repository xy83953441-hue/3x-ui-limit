...
func (s *PanelService) StartUpdate() error {
	...
	updateScript := fmt.Sprintf("set -o pipefail; %s -fLs https://raw.githubusercontent.com/xy83953441-hue/3x-ui-limit/main/update.sh | %s", shellQuote(curl), shellQuote(bash))
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/xy83953441-hue/3x-ui-limit/releases/latest")
	if err != nil {
		return "", err
	}
